...
export default function Profile(props) {
    return (
        <Box display="flex" flexGrow={1} maxWidth="18rem" p="2rem" textAlign="center" backgroundColor="white" borderRadius="1rem" sx={{ flexFlow: "column", alignItems: "center", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)" }}>
